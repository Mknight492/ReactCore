...
function logout() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, helpers_1.HF.Appfetch("api/authenticate/Logout")];
                case 1:
                    result = _a.sent();
...
function update(user) {
    var requestOptions = {
        method: "PUT",
        headers: __assign({}, helpers_1.authHeader(), { "Content-Type": "application/json" }),
        body: JSON.stringify(user)
    };
...
function handleResponse(response) {
    return new Promise(function (resolve, reject) {
        if (response.ok) {
            ...
            response.text().then(function (text) { return reject(text); });
        }
    });
}
