export const countryCodeToCountry = (code: String) => {
  code = code.trim();
  switch (code) {
    case "AD":
      return "Andorra";
    ...
    case "HK":
      return "Hong Kong";
    case "HM":
      return "Heard Island and McDonald Island";
    case "HN":
      return "Honduras";
    case "HR":
      return "Croatia";
